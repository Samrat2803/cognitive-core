"""
Script to generate cached visualization for India's GDP growth
Run this once to create the cached chart files
"""

import plotly.graph_objects as go
import os

# Data for India's GDP growth (2020-2024)
years = [2020, 2021, 2022, 2023, 2024]
gdp_growth = [-7.3, 9.1, 7.2, 6.7, 6.8]  # GDP growth percentages
...
fig.update_layout(
    title={
        'text': "India's GDP Growth Rate (2020-2024)",
...
html_path = os.path.join(artifacts_dir, 'india_gdp_cached_2024.html')
fig.write_html(html_path)
print(f"✅ Created HTML: {html_path}")

# Save as PNG (static image)
try:
    png_path = os.path.join(artifacts_dir, 'india_gdp_cached_2024.png')
...
print("\n🎉 Cached chart files created successfully!")
print(f"📊 HTML: http://localhost:8000/api/artifacts/india_gdp_cached_2024.html")
print(f"🖼️  PNG: http://localhost:8000/api/artifacts/india_gdp_cached_2024.png")
